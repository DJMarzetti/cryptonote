...
const uint64_C MONEY_SUPPLY                                  = 18446744;
...
const uint64_t DIFFICULTY_TARGET                             = 170; // seconds
...
const char     CRYPTONOTE_NAME[]                             = "edmcoin";
...
const int      P2P_DEFAULT_PORT                              = ;59001
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = ;59002
